export declare enum RawDataMemoryMode {
...
export declare enum NetworkStatus {
    None = "ZoomVideoSDKNetwork_None",
    Good = "ZoomVideoSDKNetwork_Good",
    Normal = "ZoomVideoSDKNetwork_Normal",
    Bad = "ZoomVideoSDKNetwork_Bad"
}
...
export declare enum VideoAspect {
...
export declare enum PhoneFailedReason {
...
export declare enum ChatMessageDeleteType {
...
export declare enum ZoomVideoSDKVirtualBackgroundDataType {
    None = "ZoomVideoSDKLiveTranscription_OperationType_None",
    Blur = "ZoomVideoSDKLiveTranscription_OperationType_Update",
    Image = "ZoomVideoSDKLiveTranscription_OperationType_Delete"
}
export declare enum ZoomVideoSDKDialInNumberType {
...
export declare type JoinSessionConfig = {
    sessionName: string;
...
export declare type ZoomVideoSdkType = {
...
export declare enum ConsentType {
    ConsentType_Invalid = "ConsentType_Invalid",
    ConsentType_Traditional = "ConsentType_Traditional",
    ConsentType_Individual = "ConsentType_Individual"
}
export declare enum ZoomVideoSdkCRCProtocolType {
    ZoomVideoSDKCRCProtocol_H323 = "ZoomVideoSDKCRCProtocol_H323",
    ZoomVideoSDKCRCProtocol_SIP = "ZoomVideoSDKCRCProtocol_SIP"
}
export declare class ZoomVideoSdk implements ZoomVideoSdkType {
    initSdk(config: InitConfig): any;
    joinSession(config: JoinSessionConfig): any;
    leaveSession: any;
    getSdkVersion: any;
    isInSession: any;
    cleanup: any;
    acceptRecordingConsent: any;
    declineRecordingConsent: any;
    getRecordingConsentType: any;
}
