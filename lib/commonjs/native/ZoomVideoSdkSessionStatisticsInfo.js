...
exports.ZoomVideoSdkSessionStatisticsInfo = void 0;
...
class ZoomVideoSdkSessionStatisticsInfo {
  constructor() {}
  static getInstance() {
    if (!this.instance) {
...
exports.ZoomVideoSdkSessionStatisticsInfo = ZoomVideoSdkSessionStatisticsInfo;
